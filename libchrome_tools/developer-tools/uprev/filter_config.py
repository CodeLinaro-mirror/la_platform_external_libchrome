...
WANT = [
    ...
    re.compile(
        rb"base/third_party/(dynamic_annotation|icu|nspr|valgrind|cityhash|superfasthash)"
    ),
    re.compile(
    ...
    re.compile(rb"third_party/(ipcz|jinja2|markupsafe|ply|simdutf)"),
    re.compile(
